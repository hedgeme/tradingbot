...
# IMPORTANT: exactInput takes a single tuple param, no deadline in this struct
...
def swap_exact_tokens_for_tokens(
    ...
    approve_if_needed(wallet_key, token_in, _find_router_address(), amount_in_wei, send_alerts=send_alerts)
...
def swap_v3_exact_input_once(
    ...
    approve_if_needed(wallet_key, t_in, _find_router_address(), amount_in_wei, send_alerts=send_alerts)
